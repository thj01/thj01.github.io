...
//Output
document.getElementById('succes68_lav').innerHTML = succes68_lav.toFixed(1);
document.getElementById('succes68_høj').innerHTML = succes68_høj.toFixed(1);
document.getElementById('succes95_lav').innerHTML = succes95_lav.toFixed(1);
document.getElementById('succes95_høj').innerHTML = succes95_høj.toFixed(1);
